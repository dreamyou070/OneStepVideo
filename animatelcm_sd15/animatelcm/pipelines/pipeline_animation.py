...
from animatelcm.utils.util import adjust_colors, resize_and_crop
...
class AnimationPipeline(DiffusionPipeline):
    ...
    def encode_img(self, image_path, height,  width, save_folder):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        print(f' *** get image latent *** ')
        ####################################################################################################
        img_latent = self.encode_img(image_path,height,width, save_folder)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                print(f' noise prediction with img_latnet_input')
                noise_pred = self.unet(latent_model_input,
                                       t,
                                       encoder_hidden_states=text_embeddings,
                                       time_cond=w_embedding,
                                       img_latent = img_latent_input).sample.to(dtype=latents_dtype)
