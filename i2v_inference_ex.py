...
def main(args) :
    ...
    if args.motion_control :
        print(f' setting motion_controller')
    ...
    for inference_step in inference_steps:
        ...
        savedir = f"result/{time_str}-infsteps_{inference_step}_window_attn_window_size_{window_size}_dwwp_motion_skip"
        if args.motion_control :
        ...
        for guidance_scale in guidance_scales:
            for ip_adapter_scale in ip_adapter_scales:
                ...
                for data in datas:
                    ...
                    export_to_gif(frames, os.path.join(savedir,
                                                       f"{name}_full.gif"))
